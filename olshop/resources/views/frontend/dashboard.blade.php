...
<header class="py-5">
    ...
    <div class="text-center text-xxl-start">
        <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
            <div class="text-uppercase">Make Up & Skincare</div>
        </div>
        <h1 class="display-3 fw-bolder mb-1"><span class="text-gradient d-inline">Best Product and Quality</span></h1>
    ...
    <div class="d-flex justify-content-center mt-5 mt-xxl-0">
        <div class="profile bg-gradient-primary-to-secondary">
            ...
            <div class="dots-4">
                <!-- SVG Dots-->
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                y="0px" viewBox="0 0 191.6 1215.4" style="enable-background: new 0 0 191.6 1215.4" xml:space="preserve">
                    <g transform="translate(0.000000,1280.000000) scale(0.100000,-0.100000)">
                        <path 
                            d="M227.7,12788.6c-105-35-200-141-222-248c-43-206,163-412,369-369c155,32,275,190,260,339c-11,105-90,213-190,262        C383.7,12801.6,289.7,12808.6,227.7,12788.6z">
                        </path>
        ...
        <div class="row gx-5 justify-content-center">
            <div class="col-xxl-8">
                <div class="text-center my-5">
                    <h2 class="display-5 fw-bolder"><span class="text-gradient d-inline">Welcome to Our Shop</span></h2>
                    <p class="lead fw-light mb-4">RevaShop #Make it Beauty</p>
                    <p class="text-muted">It's cheaper to buy makeup and skincare sets than you buy them one by one and
                    this makeup set can meet the daily makeup needs. Let's get our product now and.... Happy Shopping!</p>
                    <p><b>#makeup #skincare #RevaShop</b></p>
